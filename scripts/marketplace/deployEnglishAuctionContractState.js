...
async function deployEnglishAuctionContractState(
  deployerPrivateKey,
  ...
  console.info("Deploying English Auction State Contract...");
  return deployContract(deployerPrivateKey, address, code, init);
}

exports.deployEnglishAuctionContractState = deployEnglishAuctionContractState;
