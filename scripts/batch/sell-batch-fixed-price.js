 ...
 * @returns 
 */
function createOrderParam(marketplace, tokenAddress, tokenId, paymentTokenAddress, salePrice, side, expirationBnum) {
  return {
...
async function main() {
    ...
    if (myArgs.length < 3) {
        ...
        console.log("node sell-batch-fixed-price.js [0x_fixed_price_contract_address] [0x_zrc-6_contract_address] [private_key]");
        return;
    }
